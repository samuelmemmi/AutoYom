      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Lavage Pro Premium propose des services de nettoyage automobile à domicile comprenant :
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Lavage Pro Premium s'engage à fournir un service de qualité avec des produits professionnels. En cas de dommage lié à notre intervention, notre responsabilité est limitée au montant de la prestation.
            </p>
          </section>

        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Lavage Pro Premium collecte uniquement les données nécessaires à la fourniture de nos services : nom, prénom, numéro de téléphone, adresse d'intervention et informations sur le véhicule.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Lavage Pro Premium ne vend, ne loue, ni ne partage vos données personnelles avec des tiers, sauf obligation légale ou pour la fourniture du service demandé.
            </p>
          </section>

    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl">
          {/* Logo/Brand */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-premium-dark mb-4">
            {t("hero.titlee")}
          </h1>
          
          {/* Slogan */}
          <p className="text-xl md:text-2xl lg:text-3xl font-medium mb-6 italic text-premium-dark">
            {t("hero.slogan")}
          </p>
          
          {/* Description */}
          <p className="text-lg md:text-xl text-premium-dark/90 mb-8 leading-relaxed">
            {t("hero.description")}
          ...
          <div className="flex flex-wrap gap-6 mb-8 justify-center">
            <div className="flex items-center gap-2 text-premium-dark">

...
const translations = {
  fr: {
    ...
    'hero.description': "Service de lavage automobile haut de gamme à domicile.",
    'hero.description2': "Intervention mobile, 100% manuel et respectueux de votre véhicule.",
    ...
    'pricing.steps': 'Détails de la prestation',
    'pricing.step1': 'Photos avant lavage',
    'pricing.step2': 'Prélavage',
    'pricing.step3': 'Lavage',
    'pricing.step4': 'Séchage', 
    'pricing.step5': 'Nettoyage portes intérieures',
    'pricing.step6': 'Nettoyage des vitres intérieures',
    'pricing.step7': 'Lavage jantes',
    'pricing.step8': 'Nettoyage dos de sièges avant',
    'pricing.step9': 'Passage de porte',
    'pricing.step10': 'Photos après lavage',
    'pricing.step11': 'Nettoyage des vitres intérieures',
